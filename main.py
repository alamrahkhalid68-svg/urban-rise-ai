...
def build_contract_report_pdf(contract, quote, items, payments, company: str = "", project=None, financials=None) -> tuple[str, str]:
    ...
    story.extend([
        ...
        contract_paragraph("2- في حال تأخر الطرف الثاني في تسليم الموقع أو المخططات أو المواد أو الدفعات المستحقة، تمدد مدة التنفيذ تلقائياً بما يعادل مدة التأخير، ولا يعد المقاول متأخراً خلال تلك الفترة.", body_style),
        Spacer(1, 8),
    ...
    story.extend([
        ...
        contract_paragraph("4- تعتبر رسائل الواتساب والبريد الإلكتروني ومحاضر استلام المواد من وسائل الإثبات المعتمدة بين الطرفين.", body_style),
        Spacer(1, 8),
